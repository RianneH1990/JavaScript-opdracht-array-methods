...
const bornIn16thCentury = inventors.filter((inventor) => {
  return inventor.year > 1500 && inventor.year < 1600;

});
console.log(bornIn16thCentury);
...
inventors.sort((a, b) => {
  const yearA = a.passed - a.year;
  const yearB = b.passed - b.year;
  return yearB - yearA;
});
console.log(inventors);
...
const detailsEdison = inventors.find((inventor) => {
  return inventor.last === "Edison";

})
console.log(detailsEdison);